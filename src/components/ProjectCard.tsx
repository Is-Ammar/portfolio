...
export const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  ...
  return (
    <motion.div 
      ...
      className="group bg-bg-elev-1/70 backdrop-blur border border-white/10 flex flex-col h-full rounded-2xl relative overflow-hidden transition-all duration-500 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.04)_inset]"
    >
